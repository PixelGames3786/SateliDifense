...
public static class TransformExtensions
{
    ...
    public static void LookAt2D(this Transform self, Transform target, float Constant)
    {
        LookAt2D(self, target.position, Constant);
    }

    public static void LookAt2D(this Transform self, Vector3 target, float Constant)
    {
        ...
        self.rotation = Quaternion.AngleAxis(angle - Constant, Vector3.forward);
    }
